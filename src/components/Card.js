...
export default function Card(props) {
  ...
  // console.log(totval)
  return (
    <div className="card mt-3 d-flex justify-content-center align-items-center">

      <div className="card mt-3 d-flex justify-content-center align-items-center" style={{ width: "16rem", maxHeight: "360px" }}>
